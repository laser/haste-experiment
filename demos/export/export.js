...
var _0=0,_1=new T(function(){return [0,"(function(s, f) {  Haste[s] = function() {      var args = Array.prototype.slice.call(arguments,0);      args.push(0);      return E(A(f, args));    };  return 0;})"];}),_2=function(_3){return E(E(_3)[1]);},_4=function(_5){return function(_6,_){var _7=jsRound(_6),_8=A(new T(function(){var _9=jsRound(_5);return function(_a,_){return new T(function(){return [0,_9+E(_a)[1]|0];});};}),[[0,_7],_]);return new T(function(){return _2(_8);});};},_b=unCStr("addInt"),_c=function(_d){var _e=A(_d,[_]);return E(_e);},_f=function(_g){return _c(function(_){var _=0;return eval(E(_g)[1]);});},_h=function(_){var _i=A(_f,[_1,E(toJSStr(E(_b))),_4,_]);return _0;},_j=function(_){return _h(_);};
var hasteMain = function() {A(_j, [0]);};window.onload = hasteMain;